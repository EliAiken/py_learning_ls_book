...
def number_range(number):
    if number < 0:
        print(f"{number} is less than 0")           # This runs if number < 0
    elif number <= 50:
        print(f"{number} is between 0 and 50")      # This will run if the 1st statement
    elif number <= 100:                             # didn't execute 
        print(f"{number} is between 51 and 100")    # This will run if 2nd didn't run    
    else:
        print(f"{number} is greater than 100")      # This will run if 3rd didn't run
